...
return [
    "for_post" => "Kies afbeeldingen voor dit artikel",
    "manage" => "Afbeeldingen beheren",
    "media" => "Media",
    "upload" => "Afbeelding uploaden",
    "upload_new" => "Upload een afbeelding",
    "name_question" => "Wat is de naam van deze afbeelding?",
    "name" => "Naam van afbeelding",
